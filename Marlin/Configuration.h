...
#define STRING_CONFIG_H_AUTHOR "Marlin, Creality & Revoxxi" // Original author or contributor.
...
#define DEFAULT_EJERK 12  // May be used by Linear Advance
  ...
  #define JUNCTION_DEVIATION_MM 0.25 // (mm) Distance from real junction edge
