...
#
#  - example/Creality/Ender-5 Plus @ bugfix-2.1.2
#    Fetch example configuration files from the MarlinFirmware/Configurations repository
#    https://raw.githubusercontent.com/MarlinFirmware/Configurations/bugfix-2.1.2/config/examples/Creality/Ender-5%20Plus/
#
